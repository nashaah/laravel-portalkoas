...
bg-success d-md-block" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel">
    ...
    <div class="offcanvas-body">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link active text-light" href="{{route('pelajar')}}"><i class="fa-solid fa-house"></i>
                    Home
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="{{route('pelajar.jadwal')}}"><i class="fa-solid fa-calendar"></i>
                    Jadwal Bimbingan
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="#"><i class="fa-solid fa-book"></i>
                    Jadwal Ujian
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="#"><i class="fa-solid fa-user-doctor"></i>
                    Daftar Pembimbing
                </a>
            </li>
            <li class="nav-item">
